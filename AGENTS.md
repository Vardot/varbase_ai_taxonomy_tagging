...
Guidance for AI coding agents working on the Varbase AI Taxonomy Tagging recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_ai_taxonomy_tagging](https://git.drupalcode.org/project/varbase_ai_taxonomy_tagging/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_ai_taxonomy_tagging](https://www.drupal.org/project/issues/varbase_ai_taxonomy_tagging)
